  ...
  return (
    <div className="bg-gradient-to-br from-pink-50 via-blue-50 to-pink-50 py-10 px-4 sm:px-6 lg:px-8 overflow-hidden max-sm:mb-3">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-14 items-center lg:items-stretch">
          ...
          <div className="hidden lg:flex relative h-full">
            <div className="relative w-full rounded-3xl overflow-hidden shadow-xl">
              <img 
                ...
                className="w-full h-[460px] xl:h-[520px] 2xl:h-[560px] object-cover object-top"
              />
              {/* Overlay Gradient */}
          ...
          <div className="lg:hidden w-full">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 mb-6 border border-gray-100 shadow-sm">
              <p className="text-gray-700 text-sm sm:text-base md:text-lg leading-relaxed">
                Dr. Mangala Devi K R is a consultant obstetrician, gynaecologist, and conception care specialist focused on ethical, personalised treatment planning. Known for clear communication and patient first care, she guides couples through the process with continuity and transparency.
              </p>
            </div>
          ...
          <div className="hidden lg:flex h-full">
            <div className="flex h-full min-h-[460px] xl:min-h-[520px] 2xl:min-h-[560px] flex-col justify-center">
            <div className="mb-5">
            ...
            <div className=" space-y-4 mb-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[#1e2f5f] font-semibold text-lg">Women’s Health Specialist </p>
            ...
            {/* Doctor Bio */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-gray-100 shadow-sm">
