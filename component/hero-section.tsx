          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-pink-400 to-pink-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg">
