...
function FeaturedCard({ svc, hov, onEnter, isMobile }: FeaturedCardProps) {
  ...
  return (
    <div
      ...
      onMouseEnter={onEnter}
    >
      {/* Background image — fades in on overlay */}
      <img
        src={svc.image}
        alt={svc.title}
        className="absolute inset-0 w-full h-full object-cover"
      ...
      <div
        ...
        style={{
          ...
          bottom: "-10%",
          left: "-10%",
          width: showOverlay ? "160%" : "0%",
          height: showOverlay ? "160%" : "0%",
          background: "rgba(30,42,110,0.82)",
          borderRadius: "0 100% 0 0",
          transition: "width 0.55s cubic-bezier(0.65,0,0.35,1), height 0.55s cubic-bezier(0.65,0,0.35,1)",
        }}
      ...
      <div className="relative flex flex-col justify-between h-full" style={{ zIndex: 2 }}>
          ...
          {[0, 1, 2, 3].map(i => (
            <div
              ...
              style={{
                width: 18,
                height: 18,
                border: `2.2px solid ${showOverlay ? "white" : "#1e2a6e"}`,
                opacity: 0.9,
                transition: "border-color 0.3s",
              }}
            />
        ...
        <div className="mt-10">
          <h3
            ...
            style={{
              fontSize: 18,
              color: showOverlay ? "white" : "#1e2a6e",
              transition: "color 0.3s",
            }}
          >
            {svc.title}
...
/* ── NORMAL CARD ── */
function NormalCard({ svc, hovered, onEnter, isMobile }: NormalCardProps) {
  // On mobile: overlay always shown. On desktop: only on hover.
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          transition: "transform 0.3s ease",
          transform: hovered ? "scale(1.1)" : "scale(1)",
          color: showOverlay ? "white" : "#ec4899",
        }}
      >
        {svc.icon}
      </div>
      ...
      <div className="mt-auto relative" style={{ zIndex: 2 }}>
        ...
        <p
          ...
          style={{
            fontSize: 13.5,
            color: showOverlay ? "rgba(255,255,255,0.8)" : "#6b7280",
            transition: "color 0.25s",
          }}
        >
          {svc.desc}
