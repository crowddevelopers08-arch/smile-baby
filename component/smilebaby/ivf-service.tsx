        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 sm:gap-10 lg:gap-20 items-center">
          ...
          <div className="flex flex-col">
            ...
            <span
              ...
              style={{ background: "#eef1fb", color: "#2d3e7f", border: "1px solid rgba(45,62,127,0.15)" }}
            >
            ...
            >
              ...
              <br />
              Who Want{" "}
              <span className="relative inline-block" style={{ color: "#2d3e7f" }}>
                Clarity
                <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 120 8" preserveAspectRatio="none" height="6">
                  <path d="M0 6 Q30 1 60 5 Q90 9 120 3" stroke="#f9a8d4" strokeWidth="2.5" fill="none" strokeLinecap="round" />
                </svg>
              </span>
              <br />
              — Not{" "}
              <span style={{ color: "#ec4899" }}>Confusion</span>
            </h2>

            {/* Body intro */}
            <p className="text-sm sm:text-base leading-relaxed mb-6 sm:mb-8" style={{ color: "#6b7280", maxWidth: 420 }}>
              You're in the right place if any of these sound familiar. Take the first step toward answers — not more waiting.
            </p>
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      opacity: active ? 1 : 0,
                      transform: active ? "translateY(-50%) scale(1)" : "translateY(-50%) scale(0.7)",
                    }}
                  >
                    <div className="flex items-center justify-center rounded-full" style={{ width: 26, height: 26, background: "rgba(249,168,212,0.2)" }}>
                      <svg viewBox="0 0 24 24" fill="none" stroke="#f9a8d4" strokeWidth="2.5" width="13" height="13">
